...
def get_common_paths(url_list: list) -> list:
    ...
    url_files_list = url_list[i_files+1:i_url]  # Slice out directories, urls, and the first file
    if __debug__:
        print(f"PROVENANCE DEBUG | List of files only (removing first): {url_files_list}")
